...
def correlation_analysis(df1, df2, label1, label2):
    ...
    try:
        ...
        if len(numeric_cols) == 0:
            ...
            return
        aqi_avg = df2.groupby(df2["Date"].dt.year)[numeric_cols[0]].mean()
...
correlation_analysis(global_temp, air_quality, "Temperature", "AQI")

print("\n✅ All analysis completed successfully! Results saved in /visuals folder.\n")
